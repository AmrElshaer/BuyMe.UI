...
namespace BuyMe.UI.Areas.Sales.Controllers
{
    ...
    public class InvoiceTypeController : BaseController
    {
        ...
        public async Task<IActionResult> EditAddPartial([FromBody] CRUDModel<CreatEditInvoiceTypeCommond> value)
        {
            ViewBag.CustomerTypes = (await Mediator.Send(new GetAllInvoiceTypeQueries()))?.result;
