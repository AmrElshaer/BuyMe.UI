...
namespace BuyMe.Persistence.Migrations
{
    ...
    [Migration("20220317080518_removeOutBoxMessage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuyMe.Domain.Entities.PaymentReceive", b =>
                {
            ...
            modelBuilder.Entity("BuyMe.Domain.Entities.PaymentType", b =>
                {
                    b.Property<int>("PaymentTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BuyMe.Domain.Entities.PurchaseType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BuyMe.Domain.Entities.Vendor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BuyMe.Domain.Entities.VendorType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BuyMe.Domain.Entities.PaymentReceive", b =>
                {
                    b.HasOne("BuyMe.Domain.Entities.Invoice", "Invoice")
                        .WithMany()
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BuyMe.Domain.Entities.PaymentType", "PaymentType")
                        .WithMany()
            ...
            modelBuilder.Entity("BuyMe.Domain.Entities.Vendor", b =>
                {
                    b.HasOne("BuyMe.Domain.Entities.VendorType", "VendorType")
                        .WithMany()
